...
const columns = (navigate, deleteEntity,displayUniqueName) => [
    
    {
        ...
        renderCell: (params) => (
            <>
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-Mpi21subwipconsitemgroup/${params.row.recid}`,{ state: { text: displayUniqueName } } )}
                >
                    <Edit />
                </IconButton>
                <IconButton
    ...
    { field: 'mpItemcategory', headerName: 'MpItemcategory', width: 150 },
    { field: 'mpi21subwipconsnumseq', headerName: 'Mpi21subwipconsnumseq', width: 200 },
    { field: 'mpireply', headerName: 'Mpireply', width: 90 },
    { field: 'dataareaid', headerName: 'Dataareaid', width: 150 },
    
    
];

const Mpi21subwipconsitemgroupTable = () => {
    ...
    return (
        <Container>
            ...
            <Button style={{ marginBottom: 10 }}
                ...
                color="primary"
                startIcon={<Add />}
                onClick={() => navigate('/add-Mpi21subwipconsitemgroup',{ state: { text: displayUniqueName } } )}
            >
...
export default Mpi21subwipconsitemgroupTable;
