...
const columns = (navigate, deleteEntity, displayUniqueName) => [
    {
        ...
        renderCell: (params) => (
            <>
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-Mplogilityinterfaceexportexclcustomers/${params.row.recid}`, { state: { text: displayUniqueName } })}
                >
                    <Edit />
                </IconButton>
                <IconButton
    ...
    { field: 'mplogilityexportindirectcustomer', headerName: 'Mplogilityexportindirectcustomer', width: 150 },
    { field: 'createddatetime', headerName: 'Createddatetime', width: 150 },
    { field: 'warehouseAlign', headerName: 'WarehouseAlign', width: 150 },
];

const MplogilityinterfaceexportexclcustomerTable = () => {
    ...
    return (
        <Container>
            ...
            <Button
                ...
                color="primary"
                startIcon={<Add />}
                onClick={() => navigate('/add-Mplogilityinterfaceexportexclcustomers', { state: { text: displayUniqueName } })}
            >
...
export default MplogilityinterfaceexportexclcustomerTable;
