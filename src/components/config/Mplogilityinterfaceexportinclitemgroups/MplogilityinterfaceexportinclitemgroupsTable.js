...
const columns = (navigate, deleteEntity, displayUniqueName) => [
    {
        ...
        renderCell: (params) => (
            <>
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-Mplogilityinterfaceexportinclitemgroups/${params.row.recid}`, { state: { text: displayUniqueName } })}
                >
                    <Edit />
                </IconButton>
                <IconButton
...
const MplogilityinterfaceexportinclitemgroupsTable = () => {
    ...
    return (
        <Container>
            ...
            <Button
                ...
                color="primary"
                startIcon={<Add />}
                onClick={() => navigate('/add-Mplogilityinterfaceexportinclitemgroups', { state: { text: displayUniqueName } })}
            >
                Add Mplogilityinterfaceexportinclitemgroups
            </Button>
...
export default MplogilityinterfaceexportinclitemgroupsTable;
