...
const columns = (navigate, deleteEntity, displayUniqueName) => [
    {
        ...
        renderCell: (params) => (
            <>
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-MpinforInventoryStatus/${params.row.recid}`, { state: { text: displayUniqueName } })}>
                    <Edit />
                </IconButton>
                <IconButton
                    color="secondary"
    ...
    { field: 'inventoryStatus', headerName: 'InventoryStatus', width: 150 },
   
    
];

const MpinforInventoryStatus = () => {
    ...
    return (
        <Container>
            ...
            <Button
                ...
                color="primary"
                startIcon={<Add />}
                onClick={() => navigate('/add-MpinforInventoryStatus', { state: { text: displayUniqueName } })}>
                Add MpinforInventoryStatuss
            </Button>
...
export default MpinforInventoryStatus;
