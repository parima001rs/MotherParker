...
const columns = (navigate, deleteEntity, displayUniqueName) => [
    {
        ...
        renderCell: (params) => (
            <>
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-MpinforProdPoolConfigs/${params.row.recid}`, { state: { text: displayUniqueName } })}>
                    <Edit />
                </IconButton>
                <IconButton
                    color="secondary"
    ...
    { field: 'prodPool', headerName: 'ProdPool', width: 150 },
  
    
    
];

const MpinforProdPoolConfig= () => {
    ...
    return (
        <Container>
            ...
            <Button
                ...
                color="primary"
                startIcon={<Add />}
                onClick={() => navigate('/add-MpinforProdPoolConfigs', { state: { text: displayUniqueName } })}>
                Add MpinforProdPoolConfigs
            </Button>
...
export default MpinforProdPoolConfig;
