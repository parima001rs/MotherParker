...
const columns = (navigate, deleteEntity, displayUniqueName) => [
    {
        ...
        renderCell: (params) => (
            <>
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-MpinforItemGroupTables/${params.row.recid}`, { state: { text: displayUniqueName } })}>
                    <Edit />
                </IconButton>
                <IconButton
                    color="secondary"
    ...
    return (
        <Container>
            ...
            <Button
                ...
                color="primary"
                startIcon={<Add />}
                onClick={() => navigate('/add-MpinforItemGroupTables', { state: { text: displayUniqueName } })}>
                Add MpinforItemGroupTables
            </Button>
...
export default MpinforItemGroupTable;
