...
const columns = (navigate, deleteEntity, displayUniqueName) => [
    {
        ...
        renderCell: (params) => (
            <>
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-MpinforBuyerGroup/${params.row.recid}`, { state: { text: displayUniqueName } })}>
                    <Edit />
                </IconButton>
                <IconButton
                    color="secondary"
    ...
    { field: 'inventBuyerGroup', headerName: 'InventBuyerGroup', width: 150 },
   
    
];

const MpinforBuyerGroup = () => {
    ...
    return (
        <Container>
            ...
            <Button
                ...
                color="primary"
                startIcon={<Add />}
                onClick={() => navigate('/add-MpinforBuyerGroup', { state: { text: displayUniqueName } })}>
                Add MpinforBuyerGroups
            </Button>
...
export default MpinforBuyerGroup;
