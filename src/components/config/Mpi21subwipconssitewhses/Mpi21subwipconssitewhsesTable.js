...
const columns = (navigate, deleteEntity,displayUniqueName) => [
    
    {
        ...
        renderCell: (params) => (
            <>
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-Mpi21subwipconssitewhse/${params.row.recid}`,{ state: { text: displayUniqueName } })}
                >
                    <Edit />
                </IconButton>
                <IconButton
    ...
    { field: 'inventlocationid', headerName: 'Inventlocationid', width: 200 },
...
const Mpi21subwipconssitewhseTable = () => {
    ...
    return (
        <Container>
            ...
            <Button style={{ marginBottom: 10 }}
                ...
                color="primary"
                startIcon={<Add />}
                onClick={() => navigate('/add-Mpi21subwipconssitewhse',{ state: { text: displayUniqueName } })}
            >
...
export default Mpi21subwipconssitewhseTable;
