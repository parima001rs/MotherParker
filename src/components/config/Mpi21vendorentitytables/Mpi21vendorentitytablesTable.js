...
const columns = (navigate, deleteEntity,displayUniqueName) => [
    
    {
        ...
        renderCell: (params) => (
            <>
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-Mpi21vendorentitytable/${params.row.recid}`, { state: { text: displayUniqueName } })}
                >
                    <Edit />
                </IconButton>
                <IconButton
    ...
    { field: 'mpi21vendorentitytype', headerName: 'Mpi21vendorentitytype', width: 200 },
    
    
    
];

const Mpi21vendorentitytableTable = () => {
    ...
    return (
        <Container>
            ...
            <Button style={{ marginBottom: 10 }}
                ...
                color="primary"
                startIcon={<Add />}
                onClick={() => navigate('/add-Mpi21vendorentitytable', { state: { text: displayUniqueName } })}
            >
...
export default Mpi21vendorentitytableTable;
