...
const columns = (navigate, deleteEntity, displayUniqueName) => [
    {
        ...
        renderCell: (params) => (
            <>
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-InforItemGroup/${params.row.recid}`, { state: { text: displayUniqueName } })}>
                    <Edit />
                </IconButton>
                <IconButton
                    color="secondary"
    ...
    return (
        <Container>
            ...
            <Button
                ...
                color="primary"
                startIcon={<Add />}
                onClick={() => navigate('/add-InforItemGroup', { state: { text: displayUniqueName } })}>
                Add InforItemGroups
            </Button>
