...
const columns = (navigate, deleteEntity, displayUniqueName) => [
    {
        ...
        renderCell: (params) => (
            <>
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-MpinforInventOhtransferConfig/${params.row.recid}`, { state: { text: displayUniqueName } })}>
                    <Edit />
                </IconButton>
                <IconButton
                    color="secondary"
...
const MpinforInventOhtransferConfig = () => {
    ...
    return (
        <Container>
            ...
            <Button
                ...
                color="primary"
                startIcon={<Add />}
                onClick={() => navigate('/add-MpinforInventOhtransferConfig', { state: { text: displayUniqueName } })}>
                Add MpinforInventOhtransferConfigs
            </Button>
...
export default MpinforInventOhtransferConfig;
