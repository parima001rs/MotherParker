...
const columns = (navigate, deleteEntity, displayUniqueName) => [
    {
        ...
        renderCell: (params) => (
            <>
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-MpinforItemGroupConfig/${params.row.recid}`, { state: { text: displayUniqueName } })}>
                    <Edit />
                </IconButton>
                <IconButton
                    color="secondary"
    ...
    { field: 'itemGroup', headerName: 'ItemGroup', width: 150 },
   
    
];

const MpinforItemGroupConfig = () => {
    ...
    return (
        <Container>
            ...
            <Button
                ...
                color="primary"
                startIcon={<Add />}
                onClick={() => navigate('/add-MpinforItemGroupConfig', { state: { text: displayUniqueName } })}>
                Add MpinforItemGroupConfigs
            </Button>
...
export default MpinforItemGroupConfig;
