...
const columns = (navigate, deleteEntity, displayUniqueName) => [
    {
        ...
        renderCell: (params) => (
            <>
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-Mpi21_Interfacejournalnamess/${params.row.recid}`, { state: { text: displayUniqueName } })}>
                    <Edit />
                </IconButton>
                <IconButton
                    color="secondary"
    ...
    { field: 'interfacetypeid', headerName: 'Interface Type ID', width: 200 },
    { field: 'inventjournalnameid', headerName: 'Invent Journal Name ID', width: 200 },
];
    ...
    return (
        <Container>
            ...
            <Button
                ...
                color="primary"
                startIcon={<Add />}
                onClick={() => navigate('/add-Mpi21_Interfacejournalnamess', { state: { text: displayUniqueName } })}>
                Add Mpi21_Interfacejournalnamess
            </Button>
