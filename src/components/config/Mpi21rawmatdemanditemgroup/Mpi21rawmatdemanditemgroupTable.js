...
const columns = (navigate, deleteEntity,displayUniqueName) => [

    {
        ...
        renderCell: (params) => (
            <>
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-mpi21rawmatdemanditemgroup/${params.row.recid}`, { state: { text: displayUniqueName } })}
                >
                    <Edit />
                </IconButton>
                <IconButton
    ...
    { field: 'mpitemgroupid', headerName: 'Mpitemgroupid', width: 150 },
    
];

const Mpi21rawmatdemanditemgroup = () => {
    ...
    return (
        <Container>
            ...
            <Button
                ...
                color="primary"
                startIcon={<Add />}
                onClick={() => navigate('/add-Mpi21rawmatdemanditemgroup', { state: { text: displayUniqueName } })}
            >
                Add Mpi21rawmatdemanditemgroups
            </Button>
...
export default Mpi21rawmatdemanditemgroup;
