...
const columns = (navigate, deleteEntity, displayUniqueName) => [
    {
        ...
        renderCell: (params) => (
            <>
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-Wrkctrcapabilities/${params.row.recid}`, { state: { text: displayUniqueName } })}
                >
                    <Edit />
                </IconButton>
                <IconButton
    ...
    { field: 'mpcoffeetype', headerName: 'MP Coffee Type', width: 150 },
];

const WrkctrcapabilitiesTable = () => {
    ...
    return (
        <Container>
            <h2>{displayUniqueName || 'Wrkctrcapabilities Table'}</h2>
            <Button
                style={{ marginBottom: 10 }}
                variant="contained"
                color="primary"
                startIcon={<Add />}
                onClick={() => navigate('/add-Wrkctrcapabilities', { state: { text: displayUniqueName } })}
            >
...
export default WrkctrcapabilitiesTable;
