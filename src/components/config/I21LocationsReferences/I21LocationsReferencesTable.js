...
const columns = (navigate, deleteEntity, displayUniqueName) => [
    {
        ...
        renderCell: (params) => (
            <>
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-I21LocationsReferences/${params.row.recid}`, { state: { text: displayUniqueName } })}>
                    <Edit />
                </IconButton>
                <IconButton
                    color="secondary"
    ...
    return (
        <Container>
            ...
            <Button
                ...
                color="primary"
                startIcon={<Add />}
                onClick={() => navigate('/add-I21LocationsReferences', { state: { text: displayUniqueName } })}>
                Add I21LocationsReferences
            </Button>
...
export default I21LocationsReference;
