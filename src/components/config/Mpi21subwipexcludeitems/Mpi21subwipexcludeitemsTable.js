    ...
    
    {
        ...
        renderCell: (params) => (
            <>
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-Mpi21subwipexcludeitem/${params.row.recid}`, { state: { text: displayUniqueName } })}
                >
                    <Edit />
                </IconButton>
                <IconButton
...
const Mpi21subwipexcludeitemTable = () => {
    ...
    return (
        <Container>
            ...
            <Button style={{ marginBottom: 10 }}
                ...
                color="primary"
                startIcon={<Add />}
                onClick={() => navigate('/add-Mpi21subwipexcludeitem', { state: { text: displayUniqueName } })}
            >
...
export default Mpi21subwipexcludeitemTable;
