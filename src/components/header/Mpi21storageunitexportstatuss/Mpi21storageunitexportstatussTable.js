...
const columns = (navigate, deleteEntity, displayUniqueName, currInterface) => [
    {
        ...
        renderCell: (params) => (
            <>
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-Mpi21storageunitexportstatuss/${params.row.recid}`, { state: { text: displayUniqueName, interfaceName: currInterface  } })}
                >
                    <Edit />
                </IconButton>
                <IconButton
    ...
    { field: 'erprecipeno', headerName: 'ERP Recipe No.', width: 150 },
...
const MPI21STORAGEUNITEXPORTSTATUSTable = () => {
    ...
    return (
        <Container>
            ...
            {/* <Button
                ...
                color="primary"
                startIcon={<Add />}
                onClick={() => navigate('/add-MPI21STORAGEUNITEXPORTSTATUS')}
            >
                Add MPI21STORAGEUNITEXPORTSTATUS
            </Button> */}
...
export default MPI21STORAGEUNITEXPORTSTATUSTable;
