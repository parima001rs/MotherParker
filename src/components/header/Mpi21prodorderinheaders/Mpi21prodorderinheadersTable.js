...
const columns = (navigate, deleteEntity, displayUniqueName, currInterface) => [
    {
        ...
        renderCell: (params) => (
            <>
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-MPI21PRODORDERINHEADER/${params.row.recid}`, { state: { text: displayUniqueName, interfaceName: currInterface  } })}
                >
                    <Edit />
                </IconButton>
                <IconButton
    ...
    { field: 'erpshoporderno', headerName: 'ERP Shop Order No', width: 150 },
    { field: 'formulanumber', headerName: 'Formula Number', width: 150 },
    { field: 'itemno', headerName: 'Item No', width: 150 },
    { field: 'lineexists', headerName: 'Line Exists', width: 150 },
    { field: 'locationid', headerName: 'Location ID', width: 150 },
    { field: 'machine', headerName: 'Machine', width: 150 },
    { field: 'manufacturingcell', headerName: 'Manufacturing Cell', width: 150 },
    ...
    { field: 'workordertype', headerName: 'Work Order Type', width: 150 },
    { field: 'createdby', headerName: 'Created By', width: 150 },
    { field: 'book', headerName: 'Book', width: 150 },
    { field: 'vendaccount', headerName: 'Vendor Account', width: 150 },
    { field: 'vendoraccountno', headerName: 'Vendor Account No', width: 150 },
    { field: 'tableId', headerName: 'Table ID', width: 150 },
    { field: 'status', headerName: 'Status', width: 150 },

];

const MPI21PRODORDERINHEADERTable = () => {
    ...
    return (
        <Container>
            ...
            {/* <Button
                ...
                color="primary"
                startIcon={<Add />}
                onClick={() => navigate('/add-MPI21PRODORDERINHEADER')}
            >
...
export default MPI21PRODORDERINHEADERTable;
