...
const columns = (navigate, deleteEntity, displayUniqueName, currInterface) => [
    {
        ...
        renderCell: (params) => (
            <>
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-MPI21INVENTORYMOVEMENTHEADER/${params.row.recid}`, { state: { text: displayUniqueName, interfaceName: currInterface  } })}
                >
                    <Edit />
                </IconButton>
                <IconButton
    ...
    { field: 'newstoragelocation', headerName: 'New Storage Location', width: 200 },
    { field: 'newstorageunit', headerName: 'New Storage Unit', width: 150 },
    { field: 'notes', headerName: 'Notes', width: 250 },
    { field: 'quantity', headerName: 'Quantity', width: 100 },
    { field: 'quantityuom', headerName: 'Quantity UOM', width: 100 },
    { field: 'reasoncode', headerName: 'Reason Code', width: 100 },
    { field: 'sourcestoragelocation', headerName: 'Source Storage Location', width: 200 },
...
const MPI21INVENTORYMOVEMENTHEADERTable = () => {
    ...
    return (
        <Container>
            ...
            {/* <Button
                ...
                color="primary"
                startIcon={<Add />}
                onClick={() => navigate('/add-MPI21INVENTORYMOVEMENTHEADER')}
            >
                Add MPI21INVENTORYMOVEMENTHEADER
            </Button> */}
...
export default MPI21INVENTORYMOVEMENTHEADERTable;
