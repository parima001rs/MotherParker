...
const columns = (navigate, deleteEntity, displayUniqueName, currInterface) => [
    {
        ...
        renderCell: (params) => (
            <>
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-MPI21_QUANTITYADJUSTMENT/${params.row.recid}`, { state: { text: displayUniqueName, interfaceName: currInterface  } })}
                >
                    <Edit />
                </IconButton>
                <IconButton
    ...
    { field: 'lotno', headerName: 'Lot Number', width: 150 },
    { field: 'motherlotno', headerName: 'Mother Lot Number', width: 200 },
    { field: 'notes', headerName: 'Notes', width: 200 },
    { field: 'quantity', headerName: 'Quantity', width: 150 },
    { field: 'quantityuom', headerName: 'Quantity UOM', width: 150 },
    { field: 'reasoncode', headerName: 'Reason Code', width: 150 },
    { field: 'storagelocation', headerName: 'Storage Location', width: 200 },
    { field: 'storageunit', headerName: 'Storage Unit', width: 150 },
    { field: 'transactiontypeid', headerName: 'Transaction Type ID', width: 200 },
    { field: 'trxsequenceno', headerName: 'Transaction Sequence Number', width: 200 },
    { field: 'journalid', headerName: 'Journal ID', width: 200 },
    { field: 'createdby', headerName: 'Created By', width: 150 },
    { field: 'journaltransrecid', headerName: 'Journal Transaction Rec ID', width: 200 }


];

const MPI21_QUANTITYADJUSTMENTTable = () => {
    ...
    return (
        <Container>
            ...
            {/* <Button
                ...
                color="primary"
                startIcon={<Add />}
                onClick={() => navigate('/add-MPI21_QUANTITYADJUSTMENT')}
            >
                Add MPI21_QUANTITYADJUSTMENTs
            </Button> */}
...
export default MPI21_QUANTITYADJUSTMENTTable;
