...
const columns = (navigate, deleteEntity,displayUniqueName) => [
    {
        ...
        renderCell: (params) => (
            <>
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-Mpaverafexporteds/${params.row.recid}`, { state: { text: displayUniqueName } })}
                >
                    <Edit />
                </IconButton>
                <IconButton
    ...
    { field: 'linenum', headerName: 'Line Number', width: 150 },
    { field: 'prodid', headerName: 'Product ID', width: 150 },
    
];

const MpaverafexportedsTable = () => {
    ...
    return (
        <Container>
            <h2>Mpaverafexporteds Table</h2>
            <Button
                style={{ marginBottom: 10 }}
                variant="contained"
                color="primary"
                startIcon={<Add />}
                onClick={() => navigate('/add-Mpaverafexporteds', { state: { text: displayUniqueName } })}
            >
                Add Mpaverafexporteds
            </Button>
...
export default MpaverafexportedsTable;
