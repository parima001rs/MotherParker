...
const columns = (navigate, deleteEntity, displayUniqueName, currInterface) => [
    {
        ...
        renderCell: (params) => (
            <>
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-MPI21ITEMMASTERHEADER/${params.row.recid}`, { state: { text: displayUniqueName, interfaceName: currInterface  } })}
                >
                    <Edit />
                </IconButton>
                <IconButton
    ...
    { field: 'commoditycode', headerName: 'Commodity Code', width: 200 },
    { field: 'companylocation', headerName: 'Company Location', width: 150 },
    { field: 'description', headerName: 'Description', width: 200 },
    { field: 'externalgroup', headerName: 'External Group', width: 150 },
    { field: 'fairtradecompliance', headerName: 'Fairtrade Compliance', width: 200 },
    { field: 'itemid', headerName: 'Item ID', width: 150 },
    { field: 'itemno', headerName: 'Item No', width: 150 },
    { field: 'lifetime', headerName: 'Lifetime', width: 150 },
    { field: 'lifetimeunit', headerName: 'Lifetime Unit', width: 150 },
    { field: 'locationitemno', headerName: 'Location Item No', width: 200 },
    { field: 'lottracking', headerName: 'Lot Tracking', width: 150 },
    { field: 'organicitem', headerName: 'Organic Item', width: 150 },
    { field: 'origin', headerName: 'Origin', width: 150 },
    { field: 'producttype', headerName: 'Product Type', width: 150 },
    { field: 'rainforestalliance', headerName: 'Rainforest Alliance', width: 200 },
    ...
    { field: 'otherchargeitem', headerName: 'Other Charged Item', width: 150 },
...
const MPI21ITEMMASTERHEADERTable = () => {
    ...
    return (
        <Container>
            ...
            {/* <Button
                ...
                color="primary"
                startIcon={<Add />}
                onClick={() => navigate('/add-MPI21ITEMMASTERHEADER')}
            >
...
export default MPI21ITEMMASTERHEADERTable;
