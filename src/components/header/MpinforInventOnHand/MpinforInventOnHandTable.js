...
const columns = (navigate, deleteEntity,displayUniqueName) => [

    {
        ...
        renderCell: (params) => (
            ...
            <>
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-MpinforInventOnHand/${params.row.recid}`,{ state: { text: displayUniqueName } })}
                >
                    <Edit />
                </IconButton>
                <IconButton
    ...
    { field: 'onHandInventoryQuantity', headerName: 'On Hand Inventory Quantity', width: 150 },
    { field: 'inventDimId', headerName: 'Inventory Dimension ID', width: 150 },
    { field: 'site', headerName: 'Site', width: 150 },
    { field: 'warehouse', headerName: 'Warehouse', width: 150 },
    { field: 'inventStatusId', headerName: 'Inventory Status ID', width: 150 },
    { field: 'productName', headerName: 'Product Name', width: 150 },
    { field: 'buyerGroup', headerName: 'Buyer Group', width: 150 },
    { field: 'uoM', headerName: 'Unit of Measure (UOM)', width: 150 },    
];

const MpinforInventOnHandTable = () => {
...
export default MpinforInventOnHandTable;
