...
const columns = (navigate, deleteEntity, displayUniqueName, currInterface) => [
    {
        ...
        renderCell: (params) => (
            <>
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-MPI21TRANSFERINTERANDINTRAHEADER/${params.row.recid}`, { state: { text: displayUniqueName, interfaceName: currInterface  } })}
                >
                    <Edit />
                </IconButton>
                <IconButton
    ...
    { field: 'boldate', headerName: 'BOL Date', width: 150 },
    { field: 'bolnumber', headerName: 'BOL Number', width: 150 },
    { field: 'broker', headerName: 'Broker', width: 150 },
    { field: 'companylocation', headerName: 'Company Location', width: 150 },
    { field: 'erptransferorderno', headerName: 'ERP Transfer Order No', width: 150 },
    { field: 'erptransordertype', headerName: 'ERP Trans Order Type', width: 150 },
    { field: 'fromlocation', headerName: 'From Location', width: 150 },
    { field: 'shipvia', headerName: 'Ship Via', width: 150 },
    { field: 'tolocation', headerName: 'To Location', width: 150 },
    { field: 'trailerid', headerName: 'Trailer ID', width: 150 },
    { field: 'transferdate', headerName: 'Transfer Date', width: 150 },
    { field: 'transferno', headerName: 'Transfer No', width: 150 },
    { field: 'dataareaid', headerName: 'Data Area ID', width: 150 },
    { field: 'bolreceiveddate', headerName: 'BOL Received Date', width: 150 },
    { field: 'book', headerName: 'Book', width: 150 },
    { field: 'carriercode', headerName: 'Carrier Code', width: 150 },
    { field: 'dlvmode', headerName: 'Delivery Mode', width: 150 },
    { field: 'modecode', headerName: 'Mode Code', width: 150 },
    { field: 'vendaccount', headerName: 'Vendor Account', width: 150 },
    { field: 'tableId', headerName: 'Table ID', width: 150 },
]; 

const MPI21TRANSFERINTERANDINTRAHEADERTable = () => {
    ...
    return (
        <Container>
            ...
            {/* <Button
                ...
                color="primary"
                startIcon={<Add />}
                onClick={() => navigate('/add-MPI21TRANSFERINTERANDINTRAHEADER')}
            >
...
export default MPI21TRANSFERINTERANDINTRAHEADERTable;
