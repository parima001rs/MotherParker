...
const columns = (navigate, deleteEntity, displayUniqueName) => [
    {
        ...
        renderCell: (params) => (
            <>
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-Mpi21VendPaymConfirmationHeader/${params.row.recid}`, { state: { text: displayUniqueName  } })}
                >
                    <Edit />
                </IconButton>
                <IconButton
    ...
    { field: 'erpjournalNo', headerName: 'ERP Journal No', width: 200 },
    { field: 'paymentStatus', headerName: 'Payment Status', width: 150 },
    { field: 'erppaymentReferenceNo', headerName: 'ERP Payment Reference No', width: 200 },
    { field: 'purchId', headerName: 'Purchase ID', width: 150 },       
];

const Mpi21VendPaymConfirmationHeaderTable = () => {
    ...
    return (
        <Container>
            ...
            {/* <Button
                ...
                color="primary"
                startIcon={<Add />}
                onClick={() => navigate('/add-Mpi21VendPaymConfirmationHeader')}
            >
                Add Mpi21VendPaymConfirmationHeaders
            </Button> */}
...
export default Mpi21VendPaymConfirmationHeaderTable;
