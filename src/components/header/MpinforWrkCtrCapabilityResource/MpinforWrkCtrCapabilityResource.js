...

    {
        ...
        renderCell: (params) => (
            ...
            <>
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-MpinforWrkCtrCapabilityResource/${params.row.recid}`,{ state: { text: displayUniqueName } })}
                >
                    <Edit />
                </IconButton>
                <IconButton
...
const MpinforWrkCtrCapabilityResourceTable = () => {
...
export default MpinforWrkCtrCapabilityResourceTable;
