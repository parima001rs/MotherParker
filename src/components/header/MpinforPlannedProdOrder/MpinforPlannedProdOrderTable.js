...
const columns = (navigate, deleteEntity,displayUniqueName) => [

    {
        ...
        renderCell: (params) => (
            ...
            <>
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-MpinforPlannedProdOrder/${params.row.recid}`,{ state: { text: displayUniqueName } })}
                >
                    <Edit />
                </IconButton>
                <IconButton
    ...
    { field: 'orderNo', headerName: 'Order Number', width: 150 },
    ...
    { field: 'bomId', headerName: 'Bom ID', width: 150 },
    { field: 'reqPlanId', headerName: 'Request Plan ID', width: 150 },
];

const MpinforPlannedProdOrderTable = () => {
...
export default MpinforPlannedProdOrderTable;
