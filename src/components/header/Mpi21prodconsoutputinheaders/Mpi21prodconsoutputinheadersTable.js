...
const columns = (navigate, deleteEntity, displayUniqueName, currInterface) => [
    {
        ...
        renderCell: (params) => (
            <>
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-MPI21PRODCONSOUTPUTINHEADER/${params.row.recid}`, { state: { text: displayUniqueName, interfaceName: currInterface  } })}
                >
                    <Edit />
                </IconButton>
                <IconButton
    ...
    { field: 'workorderno', headerName: 'Work Order No', width: 200 },
    { field: 'workorderstatus', headerName: 'Work Order Status', width: 150 },
    { field: 'createdby', headerName: 'Created By', width: 150 },
    { field: 'tableId', headerName: 'Table ID', width: 150 },

];

const MPI21PRODCONSOUTPUTINHEADERTable = () => {
    ...
    return (
        <Container>
            ...
            {/* <Button
                ...
                color="primary"
                startIcon={<Add />}
                onClick={() => navigate('/add-MPI21PRODCONSOUTPUTINHEADER')}
            >
...
export default MPI21PRODCONSOUTPUTINHEADERTable;
