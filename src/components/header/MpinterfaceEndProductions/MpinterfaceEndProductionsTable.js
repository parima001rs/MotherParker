...
const columns = (navigate, deleteEntity, displayUniqueName, currInterface) => [
    {
        ...
        renderCell: (params) => (
            <>
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-MpinterfaceEndProductions/${params.row.recid}`, { state: { text: displayUniqueName, interfaceName: currInterface  } })}
                >
                    <Edit />
                </IconButton>
                <IconButton
    ...
    { field: 'mpendbatchorder', headerName: 'End Batch Order', width: 180 },
    { field: 'mpendordersubname', headerName: 'Order Subname', width: 180 },
    { field: 'mpendordertype', headerName: 'Order Type', width: 150 },
    { field: 'mpendproexportid', headerName: 'Pro Export ID', width: 180 },
    { field: 'mpendrecordingdate', headerName: 'Recording Date', width: 150 },
    { field: 'mpendresultweight', headerName: 'Result Weight', width: 150 },
    { field: 'mpendscheduleedweight', headerName: 'Scheduled Weight', width: 150 },
    { field: 'mpendstatus', headerName: 'Status', width: 120 },
    { field: 'mpendtransferedtimestamp', headerName: 'Transferred Timestamp', width: 200 },
    { field: 'mpendtransferred', headerName: 'Transferred', width: 120 },
    { field: 'mpendyield', headerName: 'Yield', width: 150 },
    { field: 'dataareaid', headerName: 'Data Area ID', width: 150 },
    { field: 'tableId', headerName: 'Table ID', width: 120 },
    { field: 'mpendFacility', headerName: 'Facility', width: 150 },
    { field: 'status', headerName: 'Status', width: 120 },

];

const MpinterfaceEndProductionsTable = () => {
    const { entities, setType, rowCount, setPaginationData, fetchEntitiesWithPagination, fetchEntitiesByBaseRecId, setInterfaceType, deleteEntity, resetEntity, pendingEntity, processEntity, triggerAdfPipeline } = useGenericPaginationContext();
...
export default MpinterfaceEndProductionsTable;
