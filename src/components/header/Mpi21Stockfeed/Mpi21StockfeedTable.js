...
const columns = (navigate, deleteEntity, displayUniqueName, currInterface) => [
    {
        ...
        renderCell: (params) => (
            <>
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-MPI21_STOCKFEED/${params.row.recid}`, { state: { text: displayUniqueName, interfaceName: currInterface  } })}
                >
                    <Edit />
                </IconButton>
                <IconButton
    ...
    { field: 'lotno', headerName: 'Lot No', width: 100 },
    ...
    return (
        <Container>
            ...
            {/* <Button
                ...
                color="primary"
                startIcon={<Add />}
                onClick={() => navigate('/add-MPI21_STOCKFEED')}
            >
                Add MPI21_STOCKFEEDs
            </Button> */}
...
export default MPI21_STOCKFEEDTable;
