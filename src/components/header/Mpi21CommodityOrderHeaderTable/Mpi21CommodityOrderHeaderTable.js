...
const columns = (navigate, deleteEntity, displayUniqueName) => [
    {
        ...
        renderCell: (params) => (
            <>
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-Mpi21CommodityOrderHeaderTable/${params.row.recid}`, { state: { text: displayUniqueName  } })}
                >
                    <Edit />
                </IconButton>
                <IconButton
    ...
    { field: 'futuresMarket', headerName: 'Futures Market', width: 150 },
    { field: 'futuresMonth', headerName: 'Futures Month', width: 150 },
    { field: 'lots', headerName: 'Lots', width: 150 },
    { field: 'futuresPrice', headerName: 'Futures Price', width: 150 },
    { field: 'priceUom', headerName: 'Price UOM', width: 150 },
    { field: 'priceCurrency', headerName: 'Price Currency', width: 150 },
    { field: 'fxrate', headerName: 'FX Rate', width: 150 },
    { field: 'fxcurrency', headerName: 'FX Currency', width: 150 },
    { field: 'referenceFuturesMarket', headerName: 'Reference Futures Market', width: 150 },
    { field: 'referenceFuturesMonth', headerName: 'Reference Futures Month', width: 150 },
    { field: 'referenceFuturesPrice', headerName: 'Reference Futures Price', width: 150 },
    ...
    { field: 'subBook', headerName: 'Sub Book', width: 150 },
    { field: 'quantityPerLot', headerName: 'Quantity Per Lot', width: 150 },    
];

const Mpi21CommodityOrderHeaderTable = () => {
    ...
    return (
        <Container>
            ...
            {/* <Button
                ...
                color="primary"
                startIcon={<Add />}
                onClick={() => navigate('/add-Mpi21CommodityOrderHeaderTable')}
            >
                Add Mpi21CommodityOrderHeaderTable
            </Button> */}
...
export default Mpi21CommodityOrderHeaderTable;
