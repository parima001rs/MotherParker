...
const columns = (navigate, deleteEntity,displayUniqueName) => [

    {
        ...
        renderCell: (params) => (
            ...
            <>
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-MpinforReqTransPo/${params.row.recid}`,{ state: { text: displayUniqueName } })}
                >
                    <Edit />
                </IconButton>
                <IconButton
    ...
    { field: 'inventLocationId', headerName: 'Inventory Location ID', width: 150 },
    { field: 'qty', headerName: 'Quantity', width: 150 },
    { field: 'reqDateDlv', headerName: 'Request Delivery Date', width: 150 },
    { field: 'schedFromDate', headerName: 'Scheduled From Date', width: 150 },
    { field: 'schedToDate', headerName: 'Scheduled To Date', width: 150 },
    { field: 'reqTime', headerName: 'Request Time', width: 150 },
    { field: 'itemBomId', headerName: 'Item BOM ID', width: 150 },
    { field: 'itemRouteId', headerName: 'Item Route ID', width: 150 },
    { field: 'inforStatusId', headerName: 'Infor Status ID', width: 150 },
    { field: 'inforStatus', headerName: 'Infor Status', width: 150 },
    { field: 'inforKey', headerName: 'Infor Key', width: 150 },
    { field: 'created_By', headerName: 'Created By', width: 150 },
    { field: 'creation_Time', headerName: 'Creation Time', width: 150 },
    { field: 'modification_Time', headerName: 'Modification Time', width: 150 },
    { field: 'modified_By', headerName: 'Modified By', width: 150 },
    { field: 'quantityUom', headerName: 'Quantity UOM', width: 150 },    
];

const MpinforReqTransPoTable = () => {
...
export default MpinforReqTransPoTable;
