...
const columns = (navigate, deleteEntity, displayUniqueName) => [
    {
        ...
        renderCell: (params) => (
            <>
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-Mppowerplanterrorlog/${params.row.recid}`, { state: { text: displayUniqueName } })}
                >
                    <Edit />
                </IconButton>
                <IconButton
...
const Mppowerplanterrorlog = () => {
    ...
    return (
        <Container>
            <h2>{displayUniqueName || 'Mppowerplanterrorlog Table'}</h2>
            <Button
                variant="contained"
                color="primary"
                startIcon={<Add />}
                onClick={() => navigate('/add-Mppowerplanterrorlog', { state: { text: displayUniqueName } })}
...
export default Mppowerplanterrorlog;
