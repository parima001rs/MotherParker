...
const columns = (navigate, deleteEntity, displayUniqueName) => [
    {
        ...
        renderCell: (params) => (
            <>
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-Mpsqtrackingerrorlog/${params.row.recid}`, { state: { text: displayUniqueName } })}
                >
                    <Edit />
                </IconButton>
                <IconButton
...
const Mpsqtrackingerrorlog = () => {
    ...
    return (
        <Container>
            <h2>{displayUniqueName || 'Mpsqtrackingerrorlog Table'}</h2>
            <Button
                variant="contained"
                color="primary"
                startIcon={<Add />}
                onClick={() => navigate('/add-Mpsqtrackingerrorlog', { state: { text: displayUniqueName } })}
                style={{ marginBottom: 10 }}
            >
                Add Mpsqtrackingerrorlog
            </Button>
...
export default Mpsqtrackingerrorlog;
