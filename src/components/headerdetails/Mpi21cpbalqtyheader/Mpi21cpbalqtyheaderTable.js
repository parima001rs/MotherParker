...
const columns = (navigate, deleteEntity, displayUniqueName) => [
    {
        ...
        renderCell: (params) => (
            <>
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/view-Mpi21cpbalqtyheader/${params.row.recid}`)}
                >
                    <RemoveRedEyeSharp />
                </IconButton>
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-Mpi21cpbalqtyheader/${params.row.recid}`, { state: { text: displayUniqueName  } })}
                >
                    <Edit />
                </IconButton>
                <IconButton
    ...
    { field: 'trxsequenceno', headerName: 'Transaction Sequence Number', width: 250 },    
];

const Mpi21cpbalqtyheaderTable = () => {
    ...
    return (
        <Container>
            ...
            {/* <Button
                ...
                color="primary"
                startIcon={<Add />}
                onClick={() => navigate('/add-Mpi21cpbalqtyheader')}
            >
                Add Mpi21cpbalqtyheaders
            </Button> */}
...
export default Mpi21cpbalqtyheaderTable;
