...
const columns = (navigate, deleteEntity, displayUniqueName, currInterface) => [
    {
        ...
        renderCell: (params) => (
            <>
                ...
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/view-MPI21RAWMATDEMANDSTAGING/${params.row.recid}`)}
                >
                    <RemoveRedEyeSharp />
                </IconButton>
                ...
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-MPI21RAWMATDEMANDSTAGING/${params.row.recid}`, { state: { text: displayUniqueName, interfaceName: currInterface  } })}
                >
                    <Edit />
                </IconButton>
                <IconButton
    ...
    { field: 'demandname', headerName: 'Demandname', width: 90 },


];

const MPI21RAWMATDEMANDSTAGINGTable = () => {
    ...
    return (
        <Container>
            ...
            {/* <Button
                ...
                color="primary"
                startIcon={<Add />}
                onClick={() => navigate('/add-MPI21RAWMATDEMANDSTAGING')}
            >
                Add MPI21RAWMATDEMANDSTAGINGs
            </Button> */}
...
export default MPI21RAWMATDEMANDSTAGINGTable;
