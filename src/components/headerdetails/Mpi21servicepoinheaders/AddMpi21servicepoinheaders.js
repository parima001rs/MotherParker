...
const AddMpi21servicepoinheader = () => {
    ...
    useEffect(() => {
        setType('Mpi21servicepoinheaders');
    ...
    return (
        <Container>
            <BackButton />
            <h2>Add Mpi21servicepoinheader</h2>
...
export default AddMpi21servicepoinheader;
