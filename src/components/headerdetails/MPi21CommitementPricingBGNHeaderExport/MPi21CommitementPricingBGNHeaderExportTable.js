...
const columns = (navigate, deleteEntity, displayUniqueName) => [
    {
        ...
        renderCell: (params) => (
            <>
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/view-MPi21CommitementPricingBGNHeaderExport/${params.row.recid}`)}
                >
                    <RemoveRedEyeSharp />
                </IconButton>
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-MPi21CommitementPricingBGNHeaderExport/${params.row.recid}`, { state: { text: displayUniqueName  } })}
                >
                    <Edit />
                </IconButton>
                <IconButton
    ...
    { field: 'pricingNo', headerName: 'Pricing No', width: 150 },
    { field: 'erpRefNo', headerName: 'ERP Ref No', width: 200 },
    { field: 'statusId', headerName: 'Status ID', width: 150 },
    { field: 'statusText', headerName: 'Status Text', width: 200 }
       
];

const MPi21CommitementPricingBGNHeaderExportTable = () => {
    ...
    return (
        <Container>
            ...
            {/* <Button
                ...
                color="primary"
                startIcon={<Add />}
                onClick={() => navigate('/add-MPi21CommitementPricingBGNHeaderExport')}
            >
                Add MPi21CommitementPricingBGNHeaderExports
            </Button> */}
...
export default MPi21CommitementPricingBGNHeaderExportTable;
