...
const columns = (navigate, deleteEntity, displayUniqueName, currInterface) => [
    {
        ...
        renderCell: (params) => (
            <>
                ...
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/view-MPI21COMMITMENTPRICINGBGNHEADER/${params.row.recid}`)}
                >
                    <RemoveRedEyeSharp />
                </IconButton>
                ...
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-MPI21COMMITMENTPRICINGBGNHEADER/${params.row.recid}`, { state: { text: displayUniqueName, interfaceName: currInterface  } })}
                >
                    <Edit />
                </IconButton>
                <IconButton
...
const MPI21COMMITMENTPRICINGBGNHEADERTable = () => {
    ...
    return (
        <Container>
            ...
            {/* <Button
                ...
                color="primary"
                startIcon={<Add />}
                onClick={() => navigate('/add-MPI21COMMITMENTPRICINGBGNHEADER')}
            >
                Add MPI21COMMITMENTPRICINGBGNHEADERs
            </Button> */}
...
export default MPI21COMMITMENTPRICINGBGNHEADERTable;
