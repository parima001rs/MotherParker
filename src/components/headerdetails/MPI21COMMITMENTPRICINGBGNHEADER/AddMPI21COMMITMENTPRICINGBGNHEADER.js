...
const AddMPI21COMMITMENTPRICINGBGNHEADER = () => {
    ...
    return (
        <Container>
            <BackButton />
            <h2>Add MPI21COMMITMENTPRICINGBGNHEADER</h2>
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <Button type="submit" variant="contained" color="primary">
                    Add MPI21COMMITMENTPRICINGBGNHEADER
                </Button>
            </form>
        </Container>
    );
...
export default AddMPI21COMMITMENTPRICINGBGNHEADER;
