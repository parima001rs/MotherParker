...
const columns = (navigate, deleteEntity, displayUniqueName, currInterface) => [
    {
        ...
        renderCell: (params) => (
            <>
                ...
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/view-MPI21PURCHORDERNUMHEADER/${params.row.recid}`)}
                >
                    <RemoveRedEyeSharp />
                </IconButton>
                ...
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-MPI21PURCHORDERNUMHEADER/${params.row.recid}`, { state: { text: displayUniqueName, interfaceName: currInterface  } })}
                >
                    <Edit />
                </IconButton>
                <IconButton
    ...
    { field: 'contractno', headerName: 'Contractno', width: 90 },
    { field: 'originaltrxsequenceno', headerName: 'Originaltrxsequenceno', width: 90 },
...
const MPI21PURCHORDERNUMHEADERTable = () => {
    ...
    return (
        <Container>
            ...
            {/* <Button
                ...
                color="primary"
                startIcon={<Add />}
                onClick={() => navigate('/add-MPI21PURCHORDERNUMHEADER')}
            >
                Add MPI21PURCHORDERNUMHEADERs
            </Button> */}
...
export default MPI21PURCHORDERNUMHEADERTable;
