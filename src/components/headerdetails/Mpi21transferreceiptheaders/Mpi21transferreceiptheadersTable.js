...
const columns = (navigate, deleteEntity, displayUniqueName, currInterface) => [
    {
        ...
        renderCell: (params) => (
            <>
                ...
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/view-Mpi21transferreceiptheaders/${params.row.recid}`)}
                >
                    <RemoveRedEyeSharp />
                </IconButton>
                ...
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-Mpi21transferreceiptheaders/${params.row.recid}`, { state: { text: displayUniqueName, interfaceName: currInterface  } })}
                >
                    <Edit />
                </IconButton>
                <IconButton
    ...
    { field: 'actionid', headerName: 'Actionid', width: 90 },
    { field: 'bolno', headerName: 'Bolno', width: 90 },
    { field: 'companylocation', headerName: 'Companylocation', width: 90 },
    { field: 'erpreceiptno', headerName: 'Erpreceiptno', width: 90 },
    { field: 'erptransferorderno', headerName: 'Erptransferorderno', width: 90 },
    { field: 'erptransordertype', headerName: 'Erptransordertype', width: 90 },
    { field: 'receiptdate', headerName: 'Receiptdate', width: 90 },
    { field: 'transferorderno', headerName: 'Transferorderno', width: 90 },
    { field: 'vendoraccountno', headerName: 'Vendoraccountno', width: 90 },
    { field: 'vendorrefno', headerName: 'Vendorrefno', width: 90 },
    { field: 'warehouserefno', headerName: 'Warehouserefno', width: 90 },
    { field: 'createdby', headerName: 'Warehouserefno', width: 90 },


];

const Mpi21transferreceiptheadersTable = () => {
    ...
    return (
        <Container>
            ...
            {/* <Button
                ...
                color="primary"
                startIcon={<Add />}
                onClick={() => navigate('/add-Mpi21transferreceiptheaders')}
            >
                Add Mpi21transferreceiptheaderss
            </Button> */}
...
export default Mpi21transferreceiptheadersTable;
