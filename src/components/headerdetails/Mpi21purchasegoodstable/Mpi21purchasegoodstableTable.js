...
const columns = (navigate, deleteEntity, displayUniqueName, currInterface) => [
    {
        ...
        renderCell: (params) => (
            <>
                ...
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/view-MPI21_PURCHASEGOODSTABLE/${params.row.recid}`)}
                >
                    <RemoveRedEyeSharp />
                </IconButton>
                ...
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-MPI21_PURCHASEGOODSTABLE/${params.row.recid}`, { state: { text: displayUniqueName, interfaceName: currInterface  } })}
                >
                    <Edit />
                </IconButton>
                <IconButton
    ...
    { field: 'bolno', headerName: 'BOL Number', width: 150 },
    { field: 'companylocation', headerName: 'Company Location', width: 200 },
    { field: 'erptransferorderno', headerName: 'ERP Transfer Order Number', width: 200 },
    { field: 'receiptdate', headerName: 'Receipt Date', width: 200 },
    { field: 'receiptno', headerName: 'Receipt Number', width: 200 },
    { field: 'transferorderno', headerName: 'Transfer Order Number', width: 200 },
    { field: 'vendoraccountno', headerName: 'Vendor Account Number', width: 200 },
    { field: 'vendorrefno', headerName: 'Vendor Reference Number', width: 200 },
    { field: 'warehouserefno', headerName: 'Warehouse Reference Number', width: 200 }
...
const MPI21_PURCHASEGOODSTABLETable = () => {
    ...
    return (
        <Container>
            ...
            {/* <Button
                ...
                color="primary"
                startIcon={<Add />}
                onClick={() => navigate('/add-MPI21_PURCHASEGOODSTABLE')}
            >
                Add MPI21_PURCHASEGOODSTABLEs
            </Button> */}
...
export default MPI21_PURCHASEGOODSTABLETable;
