...
const columns = (navigate, deleteEntity, displayUniqueName, currInterface) => [
    {
        ...
        renderCell: (params) => (
            <>
                ...
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/view-Mpi21vendormasterheader/${params.row.recid}`)}
                >
                    <RemoveRedEyeSharp />
                </IconButton>
                ...
                <IconButton
                    color="primary"
                    onClick={() => navigate(`/update-Mpi21vendormasterheader/${params.row.recid}`, { state: { text: displayUniqueName, interfaceName: currInterface  } })}
                >
                    <Edit />
                </IconButton>
                <IconButton
    ...
    { field: 'contactname', headerName: 'Contactname', width: 90 },
    { field: 'currency', headerName: 'Currency', width: 90 },
    { field: 'defaultlocation', headerName: 'Defaultlocation', width: 90 },
    { field: 'entitytype', headerName: 'Entitytype', width: 90 },
    { field: 'locationvendornumber', headerName: 'Locationvendornumber', width: 90 },
    { field: 'status', headerName: 'Status', width: 90 },
    { field: 'taxno', headerName: 'Taxno', width: 90 },
    { field: 'termscode', headerName: 'Termscode', width: 90 },
    { field: 'vendoraccountnumber', headerName: 'Vendoraccountnumber', width: 90 },
    { field: 'vendorname', headerName: 'Vendorname', width: 90 },


];

const Mpi21vendormasterheaderTable = () => {
    ...
    return (
        <Container>
            ...
            {/* <Button
                ...
                color="primary"
                startIcon={<Add />}
                onClick={() => navigate('/add-Mpi21vendormasterheader')}
            >
                Add Mpi21vendormasterheaders
            </Button> */}
...
export default Mpi21vendormasterheaderTable;
